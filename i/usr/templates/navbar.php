<nav id="nav-principal" class="navbar navbar-expand-lg navbar-light bg-white">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/i/usr/perfil.php">Perfil (<?php echo $_SESSION['nombre']?>)<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/i/usr/home.php">Servicios</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/i/usr/certificados.php">Mis Certificados</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="/i/usr/horario.php">Mi Horario</a>
          </li>
        </ul>
